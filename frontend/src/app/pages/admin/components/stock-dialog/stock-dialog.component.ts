  ...
  template: `
    ...
    <mat-dialog-content class="dialog-content">
      <p class="product-info">
        ...
        <strong>Estoque Atual:</strong> {{ data.product.quantidadeEstoque }} unidades
      </p>
      ...
      <form [formGroup]="stockForm">
        ...
        <mat-form-field appearance="outline" class="full-width">
          ...
          <input matInput type="number" formControlName="quantidade" placeholder="Digite a quantidade" />
          @if (stockForm.get('quantidade')?.hasError('min')) {
