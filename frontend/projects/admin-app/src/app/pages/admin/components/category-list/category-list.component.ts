...
@Component({
    ...
    <div class="category-management-container">
      <header class="category-header">
        <div>
          ...
          <p>Gerencie as categorias de produtos vinculadas a cada tipo de semijoia</p>
        </div>
  ...
  styles: [`
    ...
    .type-badge { padding: 0.25rem 0.6rem; border-radius: 12px; background: rgba(212, 175, 55, 0.15); color: #D4AF37; font-size: 0.85rem; font-weight: 600; border: 1px solid rgba(212, 175, 55, 0.3); }
...
export class CategoryListComponent implements OnInit {
  ...
  displayedColumns: string[] = ['nome', 'productTypeNome', 'descricao', 'actions'];
