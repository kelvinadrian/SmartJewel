...
import { Category } from '@shared-core';
...
@Component({
  ...
  template: `
    <div class="dialog-container">
      <h2 mat-dialog-title class="dialog-title">
        <mat-icon class="gold-icon">category</mat-icon>
      ...
      <form [formGroup]="form" (ngSubmit)="onSubmit()">
        <mat-dialog-content class="dialog-content">
          <mat-form-field appearance="outline" class="full-width">
            ...
            <input matInput formControlName="nome" placeholder="Ex: Anéis, Brincos, Relógios" />
            @if (form.get('nome')?.hasError('required')) {
              <mat-error>O nome da categoria é obrigatório</mat-error>
            }
          </mat-form-field>

          <mat-form-field appearance="outline" class="full-width">
            <mat-label>Descrição (Opcional)</mat-label>
            <textarea matInput formControlName="descricao" rows="3" placeholder="Descrição da categoria para o catálogo..."></textarea>
          </mat-form-field>
        </mat-dialog-content>
  ...
  styles: [`
    ...
    .dialog-title { display: flex; align-items: center; gap: 0.6rem; color: #D4AF37; font-weight: 700; margin-bottom: 1rem; }
  ...
  ngOnInit(): void {
    if (this.data.mode === 'edit' && this.data.category) {
      this.form.patchValue({
        ...
        descricao: this.data.category.descricao || ''
      });
    }
  }
